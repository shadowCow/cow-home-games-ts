...
describe("Room", () => {
  ...
  describe("Event Application", () => {
    test("should apply GuestJoined event", () => {
      // Arrange
      const room = createRoom("owner123", VALID_CODE);
      ...
      // Assert
      const state = room.getState();
      assert.deepEqual(state.guests, ["guest1", "guest2"]);
    });
    ...
    test("should apply GameSessionStarted event", () => {
      // Arrange
      const room = createRoom("owner123", VALID_CODE);
    ...
    test("should apply GameSessionBuilderStarted event", () => {
      // Arrange
      const room = createRoom("owner123", VALID_CODE);
    ...
    test("should apply RoomCodeChanged event", () => {
      // Arrange
      const room = createRoom("owner123", VALID_CODE);
